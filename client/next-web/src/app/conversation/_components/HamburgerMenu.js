...
export default function HamburgerMenu() {
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            >
              <section className='p-6 pt-20 bg-white h-screen'>
                  ...
                  {user == null ? (
                    ...
                    >
                      <SelectSection>
                        ...
                        >
                          <div className='font-light flex flex-col'>
                            ...
                            <span className='text-tiny whitespace-normal text-white/50'>
                              {models[0].tooltip}
                            </span>
                          </div>
                        </SelectItem>
                      ...
                      <SelectSection>
                        ...
                        >
                          <span className='text-small flex flex-row items-center gap-1'>
                            <BiSolidLockAlt />
                            Sign in needed
                          </span>
                        </SelectItem>
      ...
      <Button isIconOnly variant='light' className='min-w-8 z-50' onPress={cycleOpen}>
        {open ? <RxCross2 size='1.75em' /> : <RxHamburgerMenu size='1.75em' />}
      </Button>
    </>
  );
}
